                ...
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-8">
                        <div class="text-center">
                            <img src="Admin/assets/images/error400-cover.png" alt="error img" class="img-fluid">
                            <div class="mt-3">
                                ...
                                <a href="{{route('dashboard')}}" class="btn btn-secondary"><i class="mdi mdi-home me-1"></i>Retouner à la page d'accueil</a>
                            </div>
                        </div>
                    </div><!-- end col -->
                </div>
