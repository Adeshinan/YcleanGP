...
<head>
    ...
    <meta charset="utf-8" />
    <title>Se Connecter | Yclean</title>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Connectez-vous pour continuer sur Yclean.</p>
                                </div>
                                <div class="p-2 mt-4">
                                    @if (session('status'))
                                ...
                                @endif
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="mt-4">
                                            <button class="btn btn-secondary w-100" type="submit">Se Connecter</button>
                                        </div>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Pas de compte ? <a href="{{route('register')}}" class="fw-semibold text-primary text-decoration-underline"> S'inscrire </a> </p>
                        </div>
