...
<head>
    ...
    <meta charset="utf-8" />
    <title>Validation de votre compte | Yclean </title>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    <h5 class="text-primary">Valider votre compte</h5>
                                    <p class="text-muted"></p>
                                </div>

                                <div class="p-2">
                                    <form action="{{ route('validation.compte',$user->id) }}" method="POST">
                                        @csrf
                                        <div class="mb-3">
                                            ...
                                            <div id="passwordInput" class="form-text">Doit contenir au moins 8 caractère.</div>
                                        </div>
                                        ...
                                        <div id="password-contain" class="p-3 bg-light mb-2 rounded">
                                            <h5 class="fs-13">Mot de passe doit contenir:</h5>
                                            <p id="pass-length" class="invalid fs-12 mb-2">Minimum <b>8 charactères</b></p>
                                            <p id="pass-lower" class="invalid fs-12 mb-2">Au moins lettre <b>minuscule</b>  (a-z)</p>
                                            <p id="pass-upper" class="invalid fs-12 mb-2">Au moins lettre <b>majuscule</b> (A-Z)</p>
                                        ...
                                        <div class="mt-4">
                                            <button class="btn btn-secondary w-100" type="submit">Valider mon compte </button>
                                        </div>
